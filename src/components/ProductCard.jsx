  ...
  return (
    <Card isFooterBlurred className="rounded-3xl border-none">
      <Image
        ...
        width={250}
      />
      <div className="absolute right-2 top-2 z-10 inline-flex items-center rounded-3xl bg-white p-2 shadow-md">
        <ArrowUpRight size={20} alt="Arrow up icon on product image" />
      </div>
